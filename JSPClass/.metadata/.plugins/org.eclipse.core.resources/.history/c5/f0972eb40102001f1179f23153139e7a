...
<body>
	...
	<div>
		<xmp class="code"> [ex06_03.jsp] </xmp>
		...
		<br> <a href="ex06_02.jsp">쿠키 생성</a><br> 수정,삭제할 쿠키를 체크 한 후
		쿠키 수정, 삭제<br> <a href="ex06_04.jsp">쿠키 삭제</a><br> <a
			href="ex06_05.jsp">쿠키 수정</a><br>
	</div>
