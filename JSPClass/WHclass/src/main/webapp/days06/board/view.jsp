...
<link rel="shortcut icon"
	href="http://localhost/WHclass/images/favicon.ico">
...
<link rel="stylesheet"
	href="http://localhost/WHclass/resources/cdn-main/example.css">
...
<body>
			...
			<tfoot>
				<tr>
					<td colspan="4" align="center">
						<%-- 	      		<c:if test="false"> --%> <a
						href="<%= contextPath %>/board/edit.do?seq=${dto.seq}">수정하기</a> <a
						href="<%= contextPath %>/board/delete.do?seq=${dto.seq}">삭제하기</a>
						<%-- 	      		</c:if> --%> <input type="button"
						id="btnModalDelete" value="모달 삭제" /> <a
						href="<%= contextPath %>/board/list.do"">Home</a>
					</td>
				</tr>
			</tfoot>
		</table>
	...
	<!-- 삭제 모달 창 -->
	<div id="dialog-form" align="left" title="삭제 모달창">
		<h2>삭제하기</h2>
		<form action="<%=contextPath %>/board/delete.dom?seq=${param.seq}"
			method="post">
			<table>
				<tr>
			...
			<span style="color: red; display: none" id="spn">비밀번호가
				잘못되었습니다.</span>
		</form>
	</div>
	<script>
...
// 예 writer = 권맑음 검색 	1	[2]	의	57 게시글을 클릭한 후
// view.jsp->Homt 버튼을 클릭할 때
