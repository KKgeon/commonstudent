...
public class FileTestServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("두겟됨?");
		String uri = request.getRequestURI();//list.ss, write.ss, update.ss
		...
		//init() commandHandlerMap<rul,HashMap>
		try {
			...
			if (uri.endsWith("list.ss")) { //자료실 목록보기
			...
			}else if(uri.endsWith("delete.ss")){ //게시글 삭제
			...
			}else if(uri.endsWith("update.ss")) {//글 수정 + update.jsp
